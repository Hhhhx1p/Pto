...
API_ID = int(environ.get('API_ID', '20489101'))
API_HASH = environ.get('API_HASH', '0c673488548bbb408aab0785ec7879f1')
BOT_TOKEN = environ.get('BOT_TOKEN', "")

# Bot settings
CACHE_TIME = int(environ.get('CACHE_TIME', 1800))
PICS = (environ.get('PICS', 'https://graph.org/AUTOFILTERCLONEROBOT-07-17')).split() #SAMPLE PIC
NOR_IMG = environ.get("NOR_IMG", "https://graph.org/AUTOFILTERCLONEROBOT-07-17")
MELCOW_VID = environ.get("MELCOW_VID", "https://t.me/How_To_Open_Linkl")
SPELL_IMG = environ.get("SPELL_IMG", "https://te.legra.ph/file/15c1ad448dfe472a5cbb8.jpg")

# Admins, Channels & Users
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002171720676'))
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002167549366') # give your force subscribe channel id here else leave it blank
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Opnobitanobi:<crazy&xyz>@cluster0.tzt5srb.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
CLONE_DATABASE_URI = environ.get('CLONE_DATABASE_URI', "mongodb+srv://swetfilmbot:<crazy&xyz>@cluster0.s1ed4rk.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0") # Necessary If clone mode is true
PUBLIC_FILE_CHANNEL = environ.get('PUBLIC_FILE_CHANNEL', 'sovhsp') # Public Channel Username Without @ or without https://t.me/ and Bot Is Admin With Full Right.
